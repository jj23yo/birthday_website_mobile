...
function Picture() {
  ...
  return (
    <SectionWrapper>
      <Link to="/card">
        <p className="absolute text-4xl font-bold text-[#FDF0D5] inset-0 flex justify-center items-center text-center transform rotate-6 cursor-pointer">
          You're Getting Old! Ehehe :P
        </p>
      </Link>
      {!allImagesLoaded && (
